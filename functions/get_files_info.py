...
def get_files_info(working_directory, directory="."):
    ...
    # add guardrails to limit the scope of directories and files that the LLM is able to view.
...
# Define the function schema for get_files_info to be used in the LLM's function calling capabilities    
